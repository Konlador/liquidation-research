...
% \begin{enumerate}
  ...
  % \item \textbf{\textit{Pilno išeikvojimo} strategija efektyviausia, kai negalime rinktis likvidavimo valiutų poros.} Ši strategija generavo 75,5\% didesnį pelną nei istorinės likvidacijos, o taip pat viršijo \textit{iki uždarymo ribos} strategiją 9,8\%. Paskolos platformos savybe leidžianti likviduoti iki puse likusios skolos nepriklausomai nuo to kiek bus pagerintas sveikumo koeficintas, leidzia pasipelnyti daugiau.
  % Rekomendacija:.
